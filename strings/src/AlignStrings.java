...
public class AlignStrings extends Format{
     ...
     * @param justify - one of the enum values LEFT, CENTER or RIGHT
     */

    public AlignStrings(int maxChars, Justify justify) {
        switch(justify) {
            case LEFT:
            case CENTER:
            case RIGHT:
...
// Get the spaces in the right place.
    ...
    public static void main(String[] args) {
        ...
        AlignStrings formatter = new AlignStrings(70, Justify.CENTER);
